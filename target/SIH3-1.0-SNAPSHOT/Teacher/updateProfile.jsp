...
<%
    ...
    System.out.println("=== TEACHER UPDATE PROFILE JSP EXECUTED ===");
    ...
    if (!"Teacher".equals(currentUser.getUserType().toString())) {
    ...
    if (firstName == null || firstName.trim().isEmpty()) {
        ...
        response.sendRedirect("profile.jsp?error=missing_firstname");
        return;
    }
    
    if (email == null || email.trim().isEmpty()) {
        System.out.println("ERROR: Missing email");
        response.sendRedirect("profile.jsp?error=missing_email");
        return;
    }
    
    if (username == null || username.trim().isEmpty()) {
        System.out.println("ERROR: Missing username");
        response.sendRedirect("profile.jsp?error=missing_username");
        return;
    }
    ...
    try {
        ...
        if (user == null) {
            ...
            response.sendRedirect("profile.jsp?error=user_not_found");
            return;
        }
    ...
    System.out.println("=== TEACHER UPDATE PROFILE JSP FINISHED ===");
%>