...
<head>
    ...
    <title>Games Management - EcoLearn Admin</title>
        ...
        <% if (successMessage != null) { %>
            <% if (successMessage.equals("created")) { %>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <i class="fas fa-check-circle me-2"></i>Game created successfully!
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            <% } else if (successMessage.equals("updated")) { %>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <i class="fas fa-check-circle me-2"></i>Game updated successfully!
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            <% } else if (successMessage.equals("deleted")) { %>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <i class="fas fa-check-circle me-2"></i>Game deleted successfully!
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            <% } %>
        <% } %>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Snake & Ladder</td>
                                <td>Educational board game with environmental themes</td>
                                <td>Board Game</td>
                            ...
                            <tr>
                                <td>2</td>
                                <td>Tree Planting Challenge</td>
                                <td>Interactive game to learn about reforestation</td>
                                <td>Action Game</td>
                                <td><span class="badge bg-success">Published</span></td>
                                <td>
                                    <button class="btn btn-sm btn-outline-primary" title="Edit">
                            ...
                            <tr>
                                <td>3</td>
                                <td>Ocean Cleanup</td>
                                <td>Simulation game to clean ocean pollution</td>
                                <td>Simulation</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="admin/content/games/create" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Educational Points</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="document.querySelector('#addGameModal form').submit()">Create Game</button>
                </div>
            </div>
        </div>
    </div>
