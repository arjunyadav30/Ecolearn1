...
<body class="profile-page">
                            ...
                            <div class="user-avatar me-2">
                                <div class="avatar-placeholder">
                                    <% if (userAvatar != null && !userAvatar.isEmpty()) { %>
                                        <img src="<%= request.getContextPath() + "/" + userAvatar %>" alt="Profile" style="width: 100%; height: 100%; border-radius: 50%; object-fit: cover;">
                                    <% } else { %>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Handle form submission without backend processing
            profileEditForm.addEventListener('submit', function(e) {
                ...
                const successAlert = editProfileForm.querySelector('.alert-success');
                successAlert.style.display = 'block';
                
                // Hide error message if visible
                const errorAlert = editProfileForm.querySelector('.alert-danger');
                ...
                document.querySelectorAll('.detail-value')[1].textContent = email;
                document.querySelectorAll('.detail-value')[2].textContent = username;
