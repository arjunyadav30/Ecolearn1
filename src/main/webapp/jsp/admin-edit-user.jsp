...
<head>
    ...
    <title>Edit User - EcoLearn Admin</title>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="userType" required>
                                ...
                                <option value="Student" <%= "Student".equals(user.getUserType().toString()) ? "selected" : "" %>>Student</option>
                                <option value="Teacher" <%= "Teacher".equals(user.getUserType().toString()) ? "selected" : "" %>>Teacher</option>
                                <option value="Admin" <%= "Admin".equals(user.getUserType().toString()) ? "selected" : "" %>>Admin</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="schoolId">
                                ...
                                <option value="1" <%= user.getSchoolId() != null && user.getSchoolId() == 1 ? "selected" : "" %>>Punjab School 1</option>
                                <option value="2" <%= user.getSchoolId() != null && user.getSchoolId() == 2 ? "selected" : "" %>>Punjab School 2</option>
                                <option value="3" <%= user.getSchoolId() != null && user.getSchoolId() == 3 ? "selected" : "" %>>Delhi School 1</option>
                                <option value="4" <%= user.getSchoolId() != null && user.getSchoolId() == 4 ? "selected" : "" %>>Mumbai School 1</option>
                                <option value="" <%= user.getSchoolId() == null ? "selected" : "" %>>Other</option>
                            </select>
                        </div>
                    </div>
