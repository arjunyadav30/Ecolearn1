    ...
    try {
        ...
        if (userId != null) {
            String rankSql = "SELECT school_rank, global_rank, total_points, lessons_completed, challenges_completed, " +
                             ...
                             "points_from_bonus, current_level, level_progress, level_target " +
                ...
                <div class="dashboard-card">
                    ...
                    <div class="card-body">
                        <div class="activity-timeline">
                            <div class="activity-item" style="animation: slideInRight 0.6s ease-out;">
                                <div class="activity-icon">
                                    <i class="fas fa-trophy"></i>
                                </div>
                                <div class="activity-content">
                                    <h6>Completed Challenge: Plastic-Free Week</h6>
                                    <p>+150 eco-points</p>
                            ...
                            <div class="activity-item" style="animation: slideInRight 0.6s ease-out; animation-delay: 0.1s;">
                                <div class="activity-icon">
                                    <i class="fas fa-graduation-cap"></i>
                                </div>
                                <div class="activity-content">
                                    <h6>Finished Lesson: Renewable Energy Sources</h6>
                                    <p>+100 eco-points</p>
                            ...
                            <div class="activity-item" style="animation: slideInRight 0.6s ease-out; animation-delay: 0.2s;">
                                <div class="activity-icon">
                                    <i class="fas fa-gamepad"></i>
                                </div>
                                <div class="activity-content">
                                    <h6>Completed Game: Eco Sorting Challenge</h6>
                                    <p>+50 eco-points</p>
                            ...
                            <div class="activity-item" style="animation: slideInRight 0.6s ease-out; animation-delay: 0.3s;">
                                <div class="activity-icon">
                                    <i class="fas fa-medal"></i>
                                </div>
                                <div class="activity-content">
                                    <h6>Unlocked Achievement: Eco Warrior</h6>
                                    <p>+75 eco-points</p>
                            ...
                            <div class="activity-item" style="animation: slideInRight 0.6s ease-out; animation-delay: 0.4s;">
                                <div class="activity-icon">
                                    <i class="fas fa-leaf"></i>
                                </div>
                                <div class="activity-content">
                                    <h6>Completed Daily Challenge: Plant a Tree</h6>
                                    <p>+100 eco-points</p>
