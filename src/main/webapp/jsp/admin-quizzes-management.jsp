...
<head>
    ...
    <title>Quizzes Management - EcoLearn Admin</title>
...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">Quizzes Management</h1>
        ...
        <% if (successMessage != null) { %>
            <% if (successMessage.equals("created")) { %>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <i class="fas fa-check-circle me-2"></i>Quiz created successfully!
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            <% } else if (successMessage.equals("updated")) { %>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <i class="fas fa-check-circle me-2"></i>Quiz updated successfully!
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            <% } else if (successMessage.equals("deleted")) { %>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <i class="fas fa-check-circle me-2"></i>Quiz deleted successfully!
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            <% } %>
        <% } %>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="admin/content/quizzes/create" method="POST">
                        <div class="mb-3">
                            <label class="form-label">Quiz Title</label>
                            <input type="text" class="form-control" name="title" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Associated Lesson</label>
                            <select class="form-select" name="lessonId" required>
                                <option value="">Select Lesson</option>
                                <option value="1">Introduction to Climate Change</option>
                                <option value="2">Biodiversity Conservation</option>
                                <option value="3">Renewable Energy Sources</option>
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="timeLimit" min="1" value="30">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Passing Score (%)</label>
                            <input type="number" class="form-control" name="passingScore" min="0" max="100" value="70">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" onclick="document.querySelector('#addQuizModal form').submit()">Create Quiz</button>
                </div>
            </div>
        </div>
    </div>
